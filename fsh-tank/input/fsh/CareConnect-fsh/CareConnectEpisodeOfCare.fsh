Profile: CareConnectEpisodeOfCare1
Parent: EpisodeOfCare
Id: CareConnect-EpisodeOfCare-1
...
* referralRequest only Reference(CareConnect-ReferralRequest-1)
* careManager only Reference(CareConnect-Practitioner-1)
* team only Reference(CareConnect-CareTeam-1)

//Add correct Care Connect URL
* ^url = "https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-EpisodeOfCare-1"