Profile: CareConnectHeartRateObservation1
Parent: Observation
Id: CareConnect-HeartRate-Observation-1
...
* code.coding[snomedCT].code = #364075005 (exactly)
* code.coding[snomedCT].display 1..
* code.coding[snomedCT].display = "Heart rate" (exactly)
