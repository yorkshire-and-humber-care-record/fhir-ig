Profile: CareConnectRespiratoryRateObservation1
Parent: Observation
Id: CareConnect-RespiratoryRate-Observation-1
...
* code.coding[loinc].system ^mustSupport = false
* code.coding[loinc].code 1..
* code.coding[loinc].code = #9279-1 (exactly)
* code.coding[loinc].code ^mustSupport = false
...
* code.coding[snomedCT].code = #86290005 (exactly)
* code.coding[snomedCT].display 1..
* code.coding[snomedCT].display = "Respiratory rate" (exactly)
...
* valueQuantity[valueQuantity].code = #/min (exactly)
...
* component.valueQuantity[valueQuantity].code ^binding.description = "Common UCUM units for recording Vital Signs"
