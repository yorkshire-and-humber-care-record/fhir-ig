ValueSet: CareConnectAllergyExposureRoute
Id: CareConnect-AllergyExposureRoute-1
...
* ^name = "Care Connect Allergy Exposure Route"
* ^version = "1.1.0"
* ^status = #draft
* ^publisher = "HL7 UK"
* ^copyright = "This value set includes content from SNOMED CT, which is copyright © 2002+ International Health Terminology Standards Development Organisation (IHTSDO), and distributed by agreement between IHTSDO and HL7. Implementer use of SNOMED CT is not covered by this agreement."
* include codes from system SNOMED_CT
    where constraint = "^999000051000001100 |ePrescribing route of administration simple reference set|"

* ^url = "https://fhir.hl7.org.uk/STU3/ValueSet/CareConnect-AllergyExposureRoute-1"