ValueSet: CareConnectMedicationDosage_Route
...
* include codes from system SNOMED_CT where concept in "999000051000001100"

//Add correct Care Connect URL
* ^url = "https://fhir.hl7.org.uk/STU3/ValueSet/CareConnect-MedicationDosageRoute-1"
