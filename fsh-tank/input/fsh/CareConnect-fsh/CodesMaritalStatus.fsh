//NOTE - there is also a concept map for this - not included for now, could add later if needed

Alias: $MaritalStatus = http://hl7.org/fhir/v3/MaritalStatus
Alias: $NullFlavor = http://hl7.org/fhir/v3/NullFlavor

ValueSet: Marital_Status_Codes
...
// (Removed - appears to be a completely imaginary field?!)
//* ^extensible = true
