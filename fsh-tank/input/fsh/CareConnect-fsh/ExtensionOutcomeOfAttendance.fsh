Extension: ExtensionCareConnectOutcomeOfAttendance1
...
* ^meta.lastUpdated = "2018-02-19T16:02:12.681+00:00"
* ^version = "1.1.0"
* ^status = #draft
* ^date = "2018-11-05"
* ^publisher = "HL7 UK"
...
* valueCodeableConcept[valueCodeableConcept] ^short = "This records the outcome of an Out-Patient Attendance Consultant."
* valueCodeableConcept[valueCodeableConcept] ^binding.strength = #required
* valueCodeableConcept[valueCodeableConcept] ^binding.description = "This records the outcome of an Out-Patient Attendance Consultant."
* valueCodeableConcept[valueCodeableConcept] ^binding.valueSet = "https://fhir.hl7.org.uk/STU3/ValueSet/CareConnect-OutcomeOfAttendance-1"
*/


//* valueCodeableConcept contains valueCodeableConcept 1..1
* valueCodeableConcept only CodeableConcept
* valueCodeableConcept ^short = "This records the outcome of an Out-Patient Attendance Consultant."
* valueCodeableConcept ^binding.strength = #required
* valueCodeableConcept ^binding.description = "This records the outcome of an Out-Patient Attendance Consultant."
* valueCodeableConcept ^binding.valueSet = CareConnect-OutcomeOfAttendance-1
