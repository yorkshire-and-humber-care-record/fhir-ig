...
Id: Interweave-InterweaveSocialCareSupportReason-1
Description: "Defines the set of codes that can be used to identify the support reason."
* ^name = "Interweave Social Care Support Reason"
* include codes from system Interweave-SocialCareSupportReason-1


CodeSystem: InterweaveSocialCareSupportReason
Id: Interweave-SocialCareSupportReason-1
