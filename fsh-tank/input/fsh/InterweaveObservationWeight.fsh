Profile: InterweaveObservationWeight
Parent: Interweave-Observation
Id: Interweave-Observation-Weight
Description: "Interweave Weight (Vital signs) resource profile."
* ^status = #active
...
* code.coding[snomedCT].display = "Body weight" (exactly)
