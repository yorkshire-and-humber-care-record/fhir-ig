...
Profile: InterweaveTestEncounter
Parent: CareConnect-Encounter-1
Id: InterweaveTest-Encounter
...
* extension contains Extension-InterweaveTest-R4EncounterServiceType named serviceType 0..1
* extension[Extension-InterweaveTest-R4EncounterServiceType] ^short = "Specific type of service (pre-adopted from R4)"
* extension[Extension-InterweaveTest-R4EncounterServiceType] MS
