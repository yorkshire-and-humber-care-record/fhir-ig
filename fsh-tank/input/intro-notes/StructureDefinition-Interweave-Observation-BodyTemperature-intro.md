...
3. **code** – Fixed value of  SCT: 276885007 (Core Body Temperature).
...
5. **interpretation** – This is also known as the ‘abnormal flag’ and is regularly recorded alongside the actual result. It is used to signal the meaning of the result. We request that this value is presented as code from the SNOMED concept 105723007 Body Temperature Finding. 
