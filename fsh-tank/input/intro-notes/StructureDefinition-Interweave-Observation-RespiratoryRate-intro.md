...
## **Introduction**
This profile sets out the expectations for the interweave respiratory rate observation resource. The base for this profile is the [CareConnect-RespiratoryRate-Observation-1](https://simplifier.net/hl7fhircareconnectbaselineforstu3/careconnect-respiratoryrate-observation-1). We have enforced the use of SNOMED codes where possible and have removed the component field. This is to ensure that the valueQuantity field is used to provide the result. 
...
3. **code** – Fixed value of  SCT: 86290005 (Respiratory rate).
